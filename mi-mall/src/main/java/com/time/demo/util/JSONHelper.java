...
// 将JSON转换成String
	...
	/* *//***
			 ...
			 */
	/*
	 * public static Collection toCollection(Object object) { JSONArray jsonArray =
	 * JSONArray.fromObject(object);   return JSONArray.toCollection(jsonArray); }
	 */
	...
	/**
	 * 将json格式的字符串解析成Map对象
	 * <li>json格式：{"name":"admin","retries":"3fff","testname":"ddd","testretries":
	 * "fffffffff"}
	 */
	@SuppressWarnings("rawtypes")
